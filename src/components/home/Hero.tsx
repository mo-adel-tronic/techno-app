...
export default function Hero() {
  return (
    <header id="HEADER" className="min-h-[calc(100svh-180px)] bg-app-primary scroll-mt-16 flex lg-content-padding items-center justify-between [@media(max-width:700px)]:flex-col [@media(max-width:700px)]:justify-center [@media(max-width:700px)]:h-auto">
        <div className="grow text-center w-1/2 [@media(max-width:700px)]:w-full [@media(max-width:700px)]:grow-0">
            ...
            <p className="text-white leading-9 mb-3">
