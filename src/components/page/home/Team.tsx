      ...
      <div className="mt-8 grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-9 text-center">
        {teamworkData.teams.map((team, index) => (
          ...
          >
            ...
            <h3 className={`text-app-foreground after:block after:w-20 font-bold after:border-b-4 after:mx-auto after:my-2 ${team.color == 'red' ? 'after:border-b-red-400': ''} ${team.color == 'green' ? 'after:border-b-green-400': ''} ${team.color == 'blue' ? 'after:border-b-blue-400': ''} ${team.color == 'orange' ? 'after:border-b-orange-400': ''}`}>
              {team.title}
            </h3>
                ...
                <DrawerHeader className="text-center">
                  ...
                  <DrawerDescription className="flex items-center justify-center flex-wrap gap-4 mt-4 overflow-y-scroll h-[20rem]">
                    {team.teammates.map((teammate, i) => (
                      <div key={i} className="w-1/4 relative overflow-hidden hover:[&>div]:bottom-0">
                        <AppImage
                          src={teammate.img}
                          alt={teammate.alt}
                          width={150}
